...
CREATE TABLE `certificate` (
  ...
  FOREIGN KEY (`certificate_facility_id`) REFERENCES `certificate_facility` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE `raising_employee` (
  ...
  FOREIGN KEY (`raising_facility_id`) REFERENCES `raising_facility` (`id`) ON UPDATE CASCADE
);
...
CREATE TABLE `disposal_facility` (
  ...
  FOREIGN KEY (`vet_facility_id`) REFERENCES `vet_facility` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
);
INSERT INTO `disposal_facility` VALUES (1,'Waste Management Center','123 Disposal Rd','123-888-7890',200,1),(2,'Animal Byproduct Facility','456 Recycling Ave','234-888-8901',300,1),(3,'Eco-Friendly Disposal','789 Green Blvd','345-888-9012',150,2),(4,'Rural Waste Facility','321 Farm Rd','456-888-0123',100,2),(5,'Urban Animal Disposal','654 City Ave','567-888-1234',250,3);
...
CREATE TABLE `waste_treatment_product` (
  ...
  FOREIGN KEY (`facility_id`) REFERENCES `waste_treatment_facility` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
);
